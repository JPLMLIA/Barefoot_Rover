...
public:
	...
	*************************************************/
	void predict(float*sample,float&response,int rank);
	/************************************************
	*testset: the test set
	*SampleNum:the sample number in the testset
	*responses: the predict results
	*************************************************/
	void predict(float**testset,int SampleNum,float*responses,int rank);
	/************************************************
	...
	*************************************************/
	void readModel(const char*path, int randk, int nproc);
private:
