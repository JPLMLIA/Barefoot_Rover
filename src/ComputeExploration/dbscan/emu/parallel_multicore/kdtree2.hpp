...
public:
  ...
  kdtree2(array2dfloat& data_in,int num_points, int dims,int bucketsize,bool rearrange_in = true,int dim_in=-1);

  //shallow copy
  kdtree2(kdtree2 * other);
...
private:
  ...
  int bucketsize = 12;  // global runtime constant. 
...
public:
  ...
  //shallow copy
  kdtree2_node(kdtree2_node * other);
  //, int cut_dim_in,
