...
public:
  ...
  kdtree2(array2dfloat& data_in,int bucketsize,bool use_simd=false,bool rearrange_in = true,int dim_in=-1);
...
private:
  ...
  int bucketsize;  // global constant. Edit: We want this exposed as a hyperparameter
