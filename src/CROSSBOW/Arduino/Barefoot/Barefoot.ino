/*
Combination Arduino script to handle data from DRO, ADXL345 accelerometer, ESCON controller, px4flow 
Created: 2018-01-18
...
void loop() {
  ...
  if (Serial.available() > 0 && Serial.read()=='R'){
    ...
    Serial.print(px); Serial.print("\t");                   //px4flow x displacement
    Serial.print(py);                                       //px4flow y displacement (pixel * 100)
    Serial.println("");
